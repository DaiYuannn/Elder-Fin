...
export function getRemoteConfig() {
  return {
    defaultMode: import.meta.env.VITE_CONSOLE_DEFAULT_DATA_MODE || 'mock',
...
export async function loadConsoleSnapshot(mode = 'mock', overrides = {}) {
...
export function createConsoleRemoteChannel({
  transport,
  dataUrl,
  sseUrl,
  pollIntervalMs,
